...
class ProductScrapeSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for product in response_webdriver.xpath("//table/tr[@class='pro-list-info']"):
            yield {
                'Produto': product.xpath("./td[1]/text()").get(),
                'Preço': product.xpath("./td[2]/text()").get(),
                'Nota': product.xpath("./td[3]/text()").get(),
            }
        driver.close()